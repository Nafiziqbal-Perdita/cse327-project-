  ...
  return (
    <div className={styles.horizontalNavBar}>
      ...
      <div className={styles.navOption}
        ...
        {
          selectedLanguage === SUPPORTED_LANGUAGES.en ? "my cart" : "মাই কার্ট"
        }
      </div>
      ...
      <div className={styles.navOption}
        ...
        {
          selectedLanguage === SUPPORTED_LANGUAGES.en ? "shopping list" : "শপিং লিষ্ট"
        }
      </div>
      ...
      <div className={styles.navOption}
        ...
        {
          selectedLanguage === SUPPORTED_LANGUAGES.en ? "saved list" : "সেভড লিষ্ট"
        }
      </div>
      ...
      <div className={styles.navOption}
        onClick={() => { router.push('/') }}>
        {
          selectedLanguage === SUPPORTED_LANGUAGES.en ? "offers" : "অফার"
        }
      </div>
      ...
      <div className={styles.navOption}
        ...
        {
          selectedLanguage === SUPPORTED_LANGUAGES.en ? "fruits" : "ফলমূল "
        }
      </div>
      ...
      <div className={styles.navOption}
        ...
        {
          selectedLanguage === SUPPORTED_LANGUAGES.en ? "vegetables" : "শাকসবজি"
        }
      </div>
      ...
      <div className={styles.navOption}
        ...
        {
          selectedLanguage === SUPPORTED_LANGUAGES.en ? "all products" : "সব প্রডাক্ট"
        }
      </div>
